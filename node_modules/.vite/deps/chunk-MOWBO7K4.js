...
var RTGTransition = React8.forwardRef((_ref, ref) => {
  let {
    component: Component
...
var OffcanvasBody = React12.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React13.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime13.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React13.cloneElement(children, {
      ...innerProps,
...
var ModalContext = React14.createContext({
...
var CloseButton = React15.forwardRef(({
  className,
  variant,
...
var AbstractModalHeader = React16.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var OffcanvasHeader = React17.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var Offcanvas = React19.forwardRef(({
  ...
  const {
    onToggle
  } = (0, import_react19.useContext)(NavbarContext_default) || {};
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime19.jsx)("div", {
    ...backdropProps,
...
//# sourceMappingURL=chunk-MOWBO7K4.js.map
